...
public class Student extends Model {
    ...
    public boolean save() {
        ...
        try {
            st.executeUpdate("INSERT INTO cms.users (email, first_name, last_name, birth_date, password) \n" +
    ...
    public static Student getStudent(String... v) {
        return (Student) new Student().get(v);
    } 
